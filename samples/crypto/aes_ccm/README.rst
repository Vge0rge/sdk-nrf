...
The AES sample shows how to perform AES authenticated encryption and decryption operations using the CCM mode and a 128-bit AES key. The sample uses
additional data and a predefined sample nonce.
...
.. table-from-rows:: /includes/sample_board_rows.txt
   :header: heading
   :rows:  nrf5340dk_nrf5340_cpuappns, nrf5340pdk_nrf5340_cpuappns, nrf9160dk_nrf9160ns
